...
public class Ereditarieta {
    ...
    static void ereditarieta_scelta () {
        ...
        System.out.println("Di quale animale vuoi le caratteristiche? Scegli tra Mammiferi, Rettili o cani?:");
        ...
        if (var_tipo_animale.equalsIgnoreCase("mammiferi")) {
            ...
            Rettili rettil = new Rettili();
            rettil.rettili_sono();

            // oppure override in classe rettili di animali_sono()
            //animale_sconosciuto.animali_sono();
            

            
        }  else if (var_tipo_animale.equalsIgnoreCase("Cani")) {
            animale_sconosciuto = new Cane();

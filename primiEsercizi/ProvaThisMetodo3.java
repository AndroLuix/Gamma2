...
class Messaggi3 {
    ...
    static String var_messaggio = "variabile static";    //accesso diretto
...
class ProvaThisMetodo3 {
  public static void main (String args[]){
    ...
    miomessaggi3.var_messaggio = "cambio la stringa - oggetto"; // variabile di classe INTERNA all'oggetto
    miomessaggi3.secondo_messaggio3();
    
    
    //3bis effettuare una prova con 2 oggetti di classe Messaggi3
    
    Messaggi3 miomessaggi32 = new Messaggi3 ();
    miomessaggi32.var_messaggio = "cambio la stringa - oggetto 2";
    miomessaggi32.secondo_messaggio3();
